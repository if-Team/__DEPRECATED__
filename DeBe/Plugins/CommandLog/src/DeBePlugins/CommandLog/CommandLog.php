...
class CommandLog extends PluginBase implements Listener{
	...
	public function loadYml(){
		...
		$this->cl = (new Config($this->getServer()->getDataPath() . "/plugins/! DeBePlugins/" . "CommandLog.yml", Config::YAML, []))->getAll();
	}

	public function saveYml(){
		ksort($this->cl);
		$cl = new Config($this->getServer()->getDataPath() . "/plugins/! DeBePlugins/" . "CommandLog.yml", Config::YAML, []);
		$cl->setAll($this->cl);
		$cl->save();
	}

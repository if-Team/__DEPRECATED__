...
class ProtectBlock extends PluginBase implements Listener{
	...
	public function loadYml(){
		...
		$this->protectBlock = (new Config($this->getServer()->getDataPath() . "/plugins/! DeBePlugins/" . "ProtectBlock.yml", Config::YAML))->getAll();
	}

	public function saveYml(){
		sort($this->pb);
		$pb = new Config($this->getServer()->getDataPath() . "/plugins/! DeBePlugins/" . "ProtectBlock.yml", Config::YAML);
		$pb->setAll($this->pb);
		$pb->save();
	}

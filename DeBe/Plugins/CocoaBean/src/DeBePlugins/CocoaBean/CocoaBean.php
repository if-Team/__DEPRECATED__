...
class CocoaBean extends PluginBase implements Listener{
	...
	public function loadYml(){
		...
		$this->cb = (new Config($this->getServer()->getDataPath() . "/plugins/! DeBePlugins/" . "CocoaBean.yml", Config::YAML, []))->getAll();
	}
	...
	public function saveYml(){
		...
		ksort($cb);
		$cbc = new Config($this->getServer()->getDataPath() . "/plugins/! DeBePlugins/" . "CocoaBean.yml", Config::YAML, []);
		$cbc->setAll($cb);
		$cbc->save();
		$this->cb = $cb;
	}

...
class PVPManager extends PluginBase implements Listener{
	...
	public function onEntityDamage(EntityDamageEvent $event){
		if($this->pvp["DMG"] === false && $event->getCause() < 11) $event->setCancelled();
		if(!$event->isCancelled() && $event->getEntity() instanceof Player && $this->pvp["PVP"] !== true && $event instanceof EntityDamageByEntityEvent){

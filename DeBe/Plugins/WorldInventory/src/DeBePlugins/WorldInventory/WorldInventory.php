...
class WorldInventory extends PluginBase implements Listener{
	...
	public function loadYml(){
		...
		$this->wi = (new Config($this->getServer()->getDataPath() . "/plugins/! DeBePlugins/" . "WorldInventory.yml", Config::YAML))->getAll();
	}
	...
	public function saveYml(){
		...
		ksort($this->wi);
		$wi = new Config($this->getServer()->getDataPath() . "/plugins/! DeBePlugins/" . "WorldInventory.yml", Config::YAML);
		$wi->setAll($this->wi);
		$wi->save();
	}

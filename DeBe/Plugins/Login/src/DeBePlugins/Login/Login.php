...
class Login extends PluginBase implements Listener{
	...
	public function loadYml(){
		...
		$this->lg = (new Config($this->getServer()->getDataPath() . "/plugins/! DeBePlugins/" . "Login.yml", Config::YAML))->getAll();
	}

	public function saveYml(){
		ksort($this->lg);
		$lg = new Config($this->getServer()->getDataPath() . "/plugins/! DeBePlugins/" . "Login.yml", Config::YAML);
		$lg->setAll($this->lg);
		$lg->save();
	}

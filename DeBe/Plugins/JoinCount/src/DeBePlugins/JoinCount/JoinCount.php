...
class JoinCount extends PluginBase implements Listener{
	...
	public function loadYml(){
		...
		$this->jc = (new Config($this->getServer()->getDataPath() . "/plugins/! DeBePlugins/" . "JoinCount.yml", Config::YAML))->getAll();
	}

	public function saveYml(){
		asort($this->jc);
		$jc = new Config($this->getServer()->getDataPath() . "/plugins/! DeBePlugins/" . "JoinCount.yml", Config::YAML);
		$jc->setAll($this->jc);
		$jc->save();
	}

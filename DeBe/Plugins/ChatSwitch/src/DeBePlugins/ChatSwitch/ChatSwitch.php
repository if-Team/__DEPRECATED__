...
class ChatSwitch extends PluginBase implements Listener{
	...
	public function loadYml(){
		...
		$this->chat = (new Config($this->getServer()->getDataPath() . "/plugins/! DeBePlugins/" . "ChatSwitch.yml", Config::YAML))->getAll();
	}

	public function saveYml(){
		$chat = new Config($this->getServer()->getDataPath() . "/plugins/! DeBePlugins/" . "ChatSwitch.yml", Config::YAML);

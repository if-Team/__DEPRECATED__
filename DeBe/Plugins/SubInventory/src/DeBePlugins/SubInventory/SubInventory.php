...
class SubInventory extends PluginBase{
	...
	public function loadYml(){
		...
		$this->si = (new Config($this->getServer()->getDataPath() . "/plugins/! DeBePlugins/" . "SubInventory.yml", Config::YAML))->getAll();
	}

	public function saveYml(){
		asort($this->si);
		$si = new Config($this->getServer()->getDataPath() . "/plugins/! DeBePlugins/" . "SubInventory.yml", Config::YAML);
		$si->setAll($this->si);
		$si->save();
	}

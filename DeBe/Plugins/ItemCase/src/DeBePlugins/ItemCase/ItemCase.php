...
class ItemCase extends PluginBase implements Listener{
	...
	public function loadYml(){
		...
		$this->ic = (new Config($this->getServer()->getDataPath() . "/plugins/! DeBePlugins/" . "ItemCase.yml", Config::YAML))->getAll();
	}

	public function saveYml(){
		ksort($this->ic);
		$ic = new Config($this->getServer()->getDataPath() . "/plugins/! DeBePlugins/" . "ItemCase.yml", Config::YAML);
		$ic->setAll($this->ic);
		$ic->save();
	}

...
class ClearEntities extends PluginBase implements Listener{
	...
	public function onEntitySpawn(EntitySpawnEvent $event){
		$e = $event->getEntity();
		if($e instanceof Item || $e instanceof Arrow) $this->getServer()->getScheduler()->scheduleDelayedTask(new CallbackTask([$this,"kill"], [$e]), $this->ce[$e instanceof Item ? "Item": "Arrow"]*20);
	}
	...
	public function loadYml(){
		...
		$this->ce = (new Config($this->getServer()->getDataPath() . "/plugins/! DeBePlugins/" . "ClearEntities.yml", Config::YAML,["Item" => 60, "Arrow" => 10]))->getAll();
	}

	public function saveYml(){
		$ce = new Config($this->getServer()->getDataPath() . "/plugins/! DeBePlugins/" . "ClearEntities.yml", Config::YAML,["Item" => 60, "Arrow" => 10]);
		$ce->setAll($this->ce);
		$ce->save();
	}

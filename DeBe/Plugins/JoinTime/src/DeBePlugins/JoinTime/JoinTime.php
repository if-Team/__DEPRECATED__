...
class JoinTime extends PluginBase implements Listener{
	...
	public function loadYml(){
		...
		$this->jt = (new Config($this->getServer()->getDataPath() . "/plugins/! DeBePlugins/" . "JoinTime.yml", Config::YAML))->getAll();
	}

	public function saveYml(){
		asort($this->jt);
		$jt = new Config($this->getServer()->getDataPath() . "/plugins/! DeBePlugins/" . "JoinTime.yml", Config::YAML);
		$jt->setAll($this->jt);
		$jt->save();
	}
